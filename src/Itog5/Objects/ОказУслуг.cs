...
namespace IIS.Itog5
{
    ...
    public class ОказУслуг : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog5.Услуги fУслуги;
        
        private IIS.Itog5.Договор fДоговор;
        
        private IIS.Itog5.РасчетОстВрем fРасчетОстВрем;
        ...
        [PropertyStorage(new string[] {
                "Договор"})]
        [NotNull()]
        public virtual IIS.Itog5.Договор Договор
        {
            get
            {
                ...
                IIS.Itog5.Договор result = this.fДоговор;
        ...
        [PropertyStorage(new string[] {
                "Услуги"})]
        [NotNull()]
        public virtual IIS.Itog5.Услуги Услуги
        {
            get
            {
                ...
                IIS.Itog5.Услуги result = this.fУслуги;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Itog5.РасчетОстВрем.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РасчетОстВрем"})]
        public virtual IIS.Itog5.РасчетОстВрем РасчетОстВрем
        {
            get
            {
                ...
                IIS.Itog5.РасчетОстВрем result = this.fРасчетОстВрем;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОказУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОказУслугE", typeof(IIS.Itog5.ОказУслуг));
                }
            }
        }
    }
    ...
    public class DetailArrayOfОказУслуг : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Itog5.DetailArrayOfОказУслуг members)

        // *** End programmer edit section *** (IIS.Itog5.DetailArrayOfОказУслуг members)
        ...
        /// </summary>
        public DetailArrayOfОказУслуг(IIS.Itog5.РасчетОстВрем fРасчетОстВрем) : 
                base(typeof(ОказУслуг), ((ICSSoft.STORMNET.DataObject)(fРасчетОстВрем)))
        {
        }
        
        public IIS.Itog5.ОказУслуг this[int index]
        {
            get
            {
                return ((IIS.Itog5.ОказУслуг)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Itog5.ОказУслуг dataobject)
        {
