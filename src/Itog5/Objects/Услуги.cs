...
namespace IIS.Itog5
{
    ...
    public class Услуги : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog5.Услуга fНаименование;
        
        private IIS.Itog5.ЗатрВремя fЗатрВремя;
        ...
        public virtual IIS.Itog5.Услуга Наименование
        {
            get
            {
                ...
                IIS.Itog5.Услуга result = this.fНаименование;
        ...
        [PropertyStorage(new string[] {
                "ЗатрВремя"})]
        [NotNull()]
        public virtual IIS.Itog5.ЗатрВремя ЗатрВремя
        {
            get
            {
                ...
                IIS.Itog5.ЗатрВремя result = this.fЗатрВремя;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугE", typeof(IIS.Itog5.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугL", typeof(IIS.Itog5.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугиE", typeof(IIS.Itog5.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугиL", typeof(IIS.Itog5.Услуги));
                }
            }
        }
    }
