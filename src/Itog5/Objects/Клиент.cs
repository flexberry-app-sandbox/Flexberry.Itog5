...
namespace IIS.Itog5
{
    ...
    [View("КлиентE", new string[] {
            ...
            "НаимОрганизации as \'Наим организации\'"})]
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.Itog5.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.Itog5.Клиент));
                }
            }
        }
    }
