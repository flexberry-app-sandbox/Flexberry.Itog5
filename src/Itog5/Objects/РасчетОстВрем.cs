...
namespace IIS.Itog5
{
    ...
    public class РасчетОстВрем : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog5.DetailArrayOfОказУслуг fОказУсл;
        ...
        public virtual IIS.Itog5.DetailArrayOfОказУслуг ОказУсл
        {
            get
            {
                ...
                {
                    this.fОказУсл = new IIS.Itog5.DetailArrayOfОказУслуг(this);
                }
                IIS.Itog5.DetailArrayOfОказУслуг result = this.fОказУсл;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремE", typeof(IIS.Itog5.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремL", typeof(IIS.Itog5.РасчетОстВрем));
                }
            }
        }
    }
