...
namespace IIS.Itog5
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog5.Статус fСтатус;
        
        private IIS.Itog5.ТипДоговора fТип;
        
        private int fСтоимость;
        
        private IIS.Itog5.Клиент fКлиент;
        
        private IIS.Itog5.Длительность fДлительность;
        
        private IIS.Itog5.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        ...
        public virtual IIS.Itog5.Статус Статус
        {
            get
            {
                ...
                IIS.Itog5.Статус result = this.fСтатус;
        ...
        public virtual IIS.Itog5.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.Itog5.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.Itog5.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.Itog5.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Длительность"})]
        [NotNull()]
        public virtual IIS.Itog5.Длительность Длительность
        {
            get
            {
                ...
                IIS.Itog5.Длительность result = this.fДлительность;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Itog5.Клиент Клиент
        {
            get
            {
                ...
                IIS.Itog5.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Itog5.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Itog5.Договор));
                }
            }
        }
    }
